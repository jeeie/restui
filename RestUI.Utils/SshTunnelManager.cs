...
namespace RestUI.Utils
{
    public class SshTunnelManager
    {
        ...
        public void SetParameters(string host, int port, string username, string password)
        {
        ...
        public bool GetProxyAddress(string targetHost, int targetPort, out string proxyHost, out int proxyPort)
        {
        ...
        public void ReleaseSshProxy(string proxyHost, int proxyPort)
        {
            lock (this.SyncRoot)
            {
